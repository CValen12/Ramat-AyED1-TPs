...
c. Intercambiar dos filas, cuyos números se reciben como parámetros.

d. Intercambiar dos columnas dadas, cuyos números se reciben como parámetro.

e. Trasponer la matriz sobre sí misma. (Intercambiar cada elemento a[i,j] por a[j,i]).

f. Calcular el promedio de los elementos de una fila, cuyo número se recibe como parámetro.

g. Calcular el porcentaje de elementos con valor impar en una columna, cuyo número se
...
j. Determinar qué columnas de la matriz son palíndromos (capicúas), devolviendo una lista
con los números de las mismas.
